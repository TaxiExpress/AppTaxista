...
(function() {
  "use strict";  Monocle.templayed = function(template, data) {
...
(function() {
  ...
  Monocle.View = (function(_super) {
    ...
    View.prototype._loadTemplateFrom = function(url) {
      ...
      if (!Monocle.Templates[this.className]) {
        ...
        Monocle.Templates[this.className] = response;
      }
      return this.template = Monocle.Templates[this.className];
    };
